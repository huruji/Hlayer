(function () {
    ...
    apiPhoto.onclick = function () {
        hlayer.photo({
            ...
            position: 0,
            shadow: false,
            photos: [{img: 'img/jay/1.jpg', text: '不能说的秘密'}, {img: 'img/jay/2.jpg', text: '你永远是我眼中的苹果'}, {
                img: 'img/jay/3.jpg',
                text: '最美的不是下雨天'
            }, {img: 'img/jay/4.jpg', text: '你不要在消失了'}, {img: 'img/jay/5.jpg', text: '遇见你已经是不可思议了'}]
        })
    };
    ...
    apiPhotoRandom.onclick = function () {
        hlayer.photo({
            ...
            playTime: 5000,
            shadow: false,
            photos: [{img: 'img/moon/1.jpg', text: '秦时明月之百步飞剑'}, {img: 'img/moon/2.jpg', text: '秦时明月之夜尽天明'}, {
                img: 'img/moon/3.jpg',
                text: '秦时明月之诸子百家'
            }, {img: 'img/moon/4.jpg', text: '秦时明月之万里长城'}, {img: 'img/moon/5.jpg', text: '秦时明月之君临天下'}]
    ...
    var fastMsgRed = document.getElementById('fast-msg-red');
    fastMsgRed.onclick = function () {
        hlayer.msg({
            contentBg: '#B10C0C',
            contentColor: '#fff'
        })
    };
    var fastAlertBlue = document.getElementById('fast-alert-blue');
    fastAlertBlue.onclick = function () {
        hlayer.alert({
            mainBg: '#033e92',
            mainColor: '#ef0484'
        })
    };
    var fastAlertBlack = document.getElementById('fast-alert-black');
    fastAlertBlack.onclick = function () {
        hlayer.alert({
            mainBg: '#333',
            mainColor: '#fff',
            contentBg: '#757272',
